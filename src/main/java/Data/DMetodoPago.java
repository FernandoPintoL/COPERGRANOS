...
public class DMetodoPago {
    ...
    public DMetodoPago(int id) {
        this.id = id;
    }

    public DMetodoPago(int id, String nombre) {
        this.id = id;
        this.nombre = nombre;
    }

    public DMetodoPago(String nombre) {
        this.nombre = nombre;
    }
    
    private final String TABLE = "metodopago";
    private final String QUERY_ID = "id_metodopago";
    private final String QUERY_INSERT = String.format(
            "INSERT INTO %s (nombre) VALUES (?)", TABLE);
    private final String QUERY_UPDATE = String.format(
            "UPDATE %s SET nombre=?", TABLE, QUERY_ID);
    ...
    private String[] arrayData(ResultSet set) throws SQLException {
        return new String[]{
            String.valueOf(set.getInt("id_metodopago")),
