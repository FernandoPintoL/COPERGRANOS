...
public class NPersona {
    ...
    public Object[] guardar(String nombre, String apellido, String direccion, int telefono, String correo, int ci) throws SQLException, ParseException {
        ...
        try {
            ...
            DATOS = new DPersona(nombre, direccion, telefono, correo, ci);
            Object[] respuestaGuardado = DATOS.guardar();
            DATOS.desconectar(); // Llamada a desconectar después de guardar
    ...
    public Object[] modificar(int id, String nombre, String apellido, String direccion, int telefono, String correo, int ci) throws SQLException, ParseException {
        try {
            // Intentar guardar los datos
            DATOS = new DPersona(id, nombre, direccion, telefono, correo, ci);
            Object[] response = DATOS.modificar();
            DATOS.desconectar(); // Llamada a desconectar después de guardar
            return response;
        } catch (SQLException e) {
            // Imprimir detalles de la excepción SQLException
    ...
    public boolean eliminar(int id) throws SQLException {
        // Intentar guardar los datos
        DATOS = new DPersona(id);
        boolean response = DATOS.eliminar();
        DATOS.desconectar(); // Llamada a desconectar después de guardar
        return response;
    }
    ...
    public List<String[]> listar() throws SQLException {
        ...
        try {
            // Intentar guardar los datos
            DATOS = new DPersona();
            listado = (ArrayList<String[]>) DATOS.listar();
            DATOS.desconectar();
